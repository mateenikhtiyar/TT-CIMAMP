      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <section className="bg-[#f9f9f9] p-6 rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <input type="number" className="w-full py-2 bg-[#FFFFFF] border-2 border-gray-200 rounded-md"/>
            </div>
            <div>
              <label htmlFor="netIncome" className="block text-sm font-medium text-gray-700 mb-1">
                T12 Net Income
        ...
        <section className="bg-[#f9f9f9] p-6 rounded-lg">
          ...
          <p className="text-sm text-gray-600 mb-4">
            In this section you will upload relevant documents like the CIM/CIP. Keep in mind the buyer has already
            agreed to our{" "}
            <Link
